    ...
    if (window.location.href.includes("productId=")) {
      ...
      for (let i = 0; i < response.length; i++) {
        ...
        if (y == productId) {
          ...
          //identific div-ul care contine imaginea 1
          var thumbUL = document.getElementsByClassName("pic");
          // var thumbLI = thumbUL.querySelectorAll("li >a")
          var picture1 = document.getElementsByClassName("pic")[0];var pict1 = picture1.querySelectorAll("a>img")[0];
          var picture2 = document.getElementsByClassName("pic")[1];var pict2 = picture2.querySelectorAll("a>img")[0];
          var picture3 = document.getElementsByClassName("pic")[2];var pict3 = picture3.querySelectorAll("a>img")[0];
          picture1.setAttribute("href", response[i].image1); pict1.setAttribute("src", response[i].image1); 
          picture2.setAttribute("href", response[i].image2); pict2.setAttribute("src", response[i].image2); 
          picture3.setAttribute("href", response[i].image); pict3.setAttribute("src", response[i].image);
          ...
          // cod pentru schimbare imagine la hover
